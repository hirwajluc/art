...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        if ($result['success']) {
            ...
            $redirectUrl = $_SESSION['intended_url'] ?? 'index.php?page=dashboard';
    ...
    <div class="login-container">
        ...
        <div class="login-right">
            ...
            <div class="security-info">
                ...
                <p>Login is protected with industry-standard security measures. Use your admin credentials to access the GREATER Art Competition management panel.</p>
            </div>

            <div class="back-link">
                <a href="https://greaterproject.eu">
                    <i class="fas fa-arrow-left"></i>
                    Go to GREATER Project Official Website
                </a>
            </div>
        </div>
    </div>
